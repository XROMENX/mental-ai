...
# Import utilities as absolute modules so the server can run when executed
...
# JWT settings
# Allow running the server without extra configuration by providing
# a fallback secret key for development and testing environments.
